...
class Reader(object):
    ...
    def __init__(self, scp_path, value_processor=lambda x: x):
        ...
        #self.index_dict = {"mix": "/home/tony/dev/python/spksp/CSFP/conv-tasnet/nnet/data/tr/mix.wav", "spk1":"/home/tony/dev/python/spksp/CSFP/conv-tasnet/nnet/data/tr/spk1.wav", "spk2":"/home/tony/dev/python/spksp/CSFP/conv-tasnet/nnet/data/tr/spk2.wav"}

        #print("DICT: ", self.index_dict)
        self.index_keys = list(self.index_dict.keys())
       # print("here", self.index_keys)
       # print("HEERRERERERERERER", scp_path)
    ...
    def __getitem__(self, index):
      #  print("IIIIIIIIIIIIIIIIIIIIIIII: ",index)
       ...
       # print("INDEX: ", index, self.index_dict)
